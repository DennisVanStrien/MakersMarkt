    ...
    <section class="space-y-10">
        ...
        <section>
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="{{ route('catalogus') }}" class="text-sm font-medium text-gray-700 underline underline-offset-4 hover:text-black">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ($categories as $category)
                    <a
                        href="{{ route('catalogus', ['categorie' => $category['slug']]) }}"
        ...
        <div class="relative grid gap-8 lg:grid-cols-5 lg:items-start">
            <div class="lg:col-span-3 space-y-5">
                ...
                <div class="flex flex-wrap gap-3 pt-1">
                    <a href="{{ route('catalogus') }}" class="rounded-lg bg-gray-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-black">
                        Bekijk catalogus
                    </a>
                </div>
            </div>
